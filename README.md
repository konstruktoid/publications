...
[Building a bastion, or an example on how to lock down a website using Ansible and Docker](./bastion/README.md)\
[Comparing the DISA STIG and CIS Benchmark values](ubuntu_comparing_guides_benchmarks.md)\
